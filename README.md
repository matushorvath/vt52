...
<img src="https://raw.githubusercontent.com/matushorvath/vt52/assets/vt52.png" align="right" width="33%" height="33%">
<!-- <img src="vt52.png" align="right" width="33%" height="33%"> -->

Scale model of the DEC VT52 Terminal, to complement the [PiDP11](https://obsolescence.dev/pdp11).
...
It is intended to be scaled down to 2/3 and then 3D printed in parts.
...
This is implemented by extending the model into negative X and Y coordinates. This keep coordinates for the rest of the model unchanged,
